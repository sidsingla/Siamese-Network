...
flags.DEFINE_string('dataset_dir', '../bbox_train', 'String: Your dataset directory')

#State output directory for output tfrecords
flags.DEFINE_string('output_dir', '../mars_tfrecords_with_filename', 'String: Your output directory')
...
def main():
    ...
    for class_ in class_names:
        files_matching_class = [fil for fil in photo_filenames if fil.startswith(class_)]
        val_samples_cnt = int(len(files_matching_class) * FLAGS.validation_size)
    ...
    _convert_dataset('train', training_filenames, class_names_to_ids,
                     ...
                     _NUM_SHARDS = FLAGS.num_shards, output_dir = FLAGS.output_dir)
